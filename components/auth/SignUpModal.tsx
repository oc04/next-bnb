...
const SignUpModal: React.FC<IProps> = ({ closeModal }) => {
    ...
    return (
        <Container onSubmit={onSubmitSignUp}>
            ...
            <div className="input-wrapper">
                <Input placeholder="성(예:홍)" icon={<PersonIcon />} value={firstname} onChange={onChangeFristname}  useValidation isValid={!!firstname} errorMessage="성을 입력하세요." />
            </div>
            ...
            <div className="sign-up-modal-birthday-selectors">
                <div className="sign-up-modal-birthday-month-selector">
                    <Selector options={monthList} defaultValue="월" value={birthMonth} onChange={onChangeBirthMonth} isValid={!!birthMonth} disabledOptions={disabledMonths} />
                </div>
                <div className="sign-up-modal-birthday-day-selector">
                    <Selector options={dayList} defaultValue="일" value={birthDay} onChange={onChangeBirthDay} isValid={!!birthDay} disabledOptions={disabledDays} />
                </div>
                <div className="sign-up-modal-birthday-year-selector">
                    <Selector options={yearList} defaultValue="년" value={birthYear} onChange={onChangeBirthYear} isValid={!!birthYear} disabledOptions={disabledYears} />
                </div>
            </div>
